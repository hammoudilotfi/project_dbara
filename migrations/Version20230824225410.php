 ...
 */
final class Version20230824225410 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE savednote ADD CONSTRAINT FK_66ACC4E65B9C9299 FOREIGN KEY (abonnees_id) REFERENCES abonnes (id)');
